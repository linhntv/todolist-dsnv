...
<template>
  ...
  <!-- form modal add todolist -->
  <div class="form-modal" v-if="isSubmit">
    <div class="modal-warp">
      ...
      <div class="warp-note">
        <button class="btn submit" @click="isSubmit=!isSubmit">Cancle</button>
        <button 
        class="btn submit" 
        @click="addItems">
          Add
...
export default {
  data(){
    return {
      items:[
        {name:'Nguyễn Văn Linh',age:27,adress:'Quảng Nam',position:'Nhân viên',done:false,},
        {name:'Phan thị Dung',age:26,adress:'Quảng Nam',position:'QC',done:false,},
        {name:'Nguyễn Lê Đình tiên',age:27,adress:'Quảng Nam',position:'Nhân viên',done:false,},
        {name:'Nguyễn Văn B',age:27,adress:'Quảng Nam',position:'Nhân viên',done:false,},
      ],
        ...
        .table{
          ...
          tbody{
            th{
              border:2px solid rgb(101, 10, 10);
              i:nth-child(1){
                background-color: rgb(175, 77, 25);
                padding: 4px 8px;
                border-radius: 4px;
              }
              span{
